...
?>
<div class="container">
    <form class="form-signin" action="/chat/user/registerpost/" method="post" >
        ...
        <p>Je suis déjà membre ?</p>
        <div><a href="/chat/user/register" class="btn btn-lg btn-info btn-block ">Connectez-vous !</a></div>
    </form>
</div>
